    ...
    render() {
        return (
            <div className="body-container">
                <SideBar className="side-bar" header="Addition" items={additionItems} chooseRange={this.getRange.bind(this)}/>
                <MainContentContainer className="main-container" range={this.state.range}/>
            </div>
        )
    }
}
